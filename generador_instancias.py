...
for i in range(0, 15):
    ...
    T = 2
    generar_instancia(jotapath+"_pequena_"+str(i+1)+".dzn",N,H,T,0,N*3/5)

    #instancia mediana
    H = int(random.uniform(7, 14))
    N = int(random.uniform(15, 45))
    T = 3
    generar_instancia(jotapath+"_mediana_"+str(i+1)+".dzn",N,H,T,0,N*3/5)

    #instancia grande
    H = int(random.uniform(14, 28))
    N = int(random.uniform(45, 90))
    T = 3
    generar_instancia(jotapath+"_grande_"+str(i+1)+".dzn",N,H,T,0,N*3/5)
